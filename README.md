...
🧱 Atomic Design
The project uses Atomic Design methodology for component structure:

Atoms → UI primitives (e.g., buttons, loaders)

Molecules → Combined atoms (e.g., input with label)

Organisms → Complex UI blocks (e.g., Coin Row, Coin Card)

Templates & Pages → Layouts and route views
...
Infinite scrolling for market data (no pagination)
